        ...
        <div class="container">
            ...
            <div class="container-description">
                <div class="container-img">
                    ...
                    <img src="<?= $product->img();?>" alt="LBJ card" id="first_pict">
                    <img src="<?= $product->second_img();?>" alt="LBJ card" class="second-card-img" id="second_pict">
                    <img src="<?= $product->third_img();?>" alt="LBJ card" class="third-card-img" id="third_pict">
