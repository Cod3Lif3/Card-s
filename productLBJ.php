...
<div class="container-description">
    <div>
        <img src="asset/img/lebron cardgoat 1.png" alt="LBJ card">
    </div>
    <div class="descript">
        <h3>Description</h3>
        <p>Cette carte Lebron James GOAT EDITION est l’une des plus rares dans le monde. Finition en feuilles d’or et plastifiée manuellement, cette carte est sans aucun doute celle qui manque à votre collection</p>
        <h3>Disponibilité</h3>
